...
/*
public class ProcessEventParameter { 
    public string Name { get; private set; }
    public nint Value { get; private set; }
    public nint Mask { get; private set; }

    
    ProcessEventParameter(string Name, nint Value, nint Mask)
    {
        this.Name = Name;
        this.Value = Value;
        this.Mask = Mask;
    ...
    public static unsafe ProcessEventParameter Create<TType>(string Name, TType Value)
        where TType: unmanaged
    {
        var Mask = (1 << (sizeof(TType) * 8)) - 1;
    }
}
*/
